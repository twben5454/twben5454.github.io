<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xs_md.aspx.cs" Inherits="FineUIPro.Examples.block.xs_md" %>
...
<body class="f-body-bgcolor">
    <form id="form1" runat="server">
        ...
        <f:Panel IsFluid="true" runat="server"
            ...
            <Items>
                <f:Panel CssClass="blockpanel" Block="6" BlockMD="3"
