<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="only_xs.aspx.cs" Inherits="FineUIPro.Examples.block.only_xs" %>
...
<body class="f-body-bgcolor">
    <form id="form1" runat="server">
        ...
        <f:Panel IsFluid="true" runat="server"
            ...
            <Items>
                <f:Panel CssClass="blockpanel" Block="3"
