<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="same_width.aspx.cs" Inherits="FineUIPro.Examples.block.same_width" %>
...
<body class="f-body-bgcolor">
    <form id="form1" runat="server">
        ...
        <f:Panel IsFluid="true" runat="server"
            ...
            <Items>
                <f:Panel CssClass="blockpanel" BlockSM="6" BlockMD="4" BlockLG="3"
