...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="商品标签管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            <Columns>
                <f:BoundField Width="100px" DataField="UnitID" DataFormatString="{0} " HeaderText="標签ID" SortField="UnitID" /> 
                <f:BoundField Width="100px" DataField="UnitName" DataFormatString="{0} " HeaderText="標签名稱" SortField="UnitName" /> 
                ...
                <f:Form ID="SimpleForm1" CssClass="blockpanel" BodyPadding="5 5 0 5" LabelAlign="right" ShowHeader="false" LabelWidth="120px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow5">
                            <Items>
                                <f:TextBox runat="server" ID="UnitID" Label ="標签ID" Required="true" ShowRedStar="true" /> 
                            </Items>
                        </f:FormRow>
                        <f:FormRow ID="FormRow6">
                            <Items>
                                <f:TextBox runat="server" ID="UnitName" Label ="標签名稱" Required="true" ShowRedStar="true" /> 
                            </Items>
                        </f:FormRow>
                    </Rows>
                </f:Form>
