...
public partial class Unit : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblUnit   Where UnitID <> '' ";
        if (this.txtSearch.Text.Length > 0)
        {
            strSQL += " and (UnitID Like '%" + this.txtSearch.Text + "%' or UnitName like '%" + this.txtSearch.Text + "%')";
        }
    ...
    protected void Grid1_RowCommand(object sender, FineUIPro.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Action1")
        {
            ...
            this.UnitID.Text = keys[0].ToString();
            this.UnitID.Readonly = true;
            this.UnitName.Text = keys[1].ToString();
        ...
        if (e.CommandName == "Action2")
        {
            ...
            strSQL = @"Update   tblUnit Set IsUse = '" + IsUse + "',Updated = '" + DB.getObject().GetCreated(this) + "'  Where UnitID = '" + keys[0].ToString() + "'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            strSQL = "Insert Into tblUnit (UnitName ,Created) Values ('" + this.UnitName.Text + "','" + DB.getObject().GetCreated(this) + "')";
            if (DB.getObject().Execute(strSQL, null, false).Success == true)
            {
        ...
        {
            strSQL = "Update tblUnit  Set UnitName = '" + this.UnitName.Text + "',Updated = '" + DB.getObject().GetCreated(this) + "' Where UnitID ='" + this.UnitID.Text + "'";
            if (DB.getObject().Execute(strSQL, null, false).Success == true)
            {
