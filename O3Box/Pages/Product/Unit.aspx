...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Cosmetic 管理系統</title>
</head>
<body>
    <form id="form1" runat="server">
        <f:PageManager ID="PageManager1" AutoSizePanelID="RegionPanel1" runat="server" ></f:PageManager>
        <uc1:WebUserControl2 runat="server" ID="WebUserControl2" />
        <f:Grid ID="Grid1" Title="商品單位管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            DataKeyNames="UnitID,UnitName,IsUse"  SortField="UnitID" SortDirection="Desc"  >
            <Toolbars>
                <f:Toolbar ID="Toolbar3" Position="Top" runat="server" >
                    <Items>
                        <f:Button runat="server" ID ="btnAdd" Icon="Add" Text="增加" OnClick="btnAdd_Click" ></f:Button>
                        <f:Textbox runat="server" ID ="txtSearch" Label="關鍵字" EmptyText="請輸入關鍵字查詢"></f:Textbox>
            ...
            <Columns>
                <f:BoundField Width="100px" DataField="UnitID" DataFormatString="{0} " HeaderText="ID" SortField="UnitID" /> 
                <f:BoundField Width="100px" DataField="UnitName" DataFormatString="{0} " HeaderText="名稱" SortField="UnitName" /> 
                <f:CheckBoxField Width="80px" RenderAsStaticField="true" DataField="IsUse" HeaderText="是否使用" />
                <f:BoundField Width="200px" DataField="Created" DataFormatString="{0} " HeaderText="建檔" SortField="QAAnswer" Hidden="true" /> 
                <f:BoundField Width="200px" DataField="Updated" DataFormatString="{0} " HeaderText="更檔" SortField="QAAnswer" Hidden="true" /> 
                ...
                <f:Form ID="SimpleForm1" CssClass="blockpanel" BodyPadding="5 5 0 5" LabelAlign="right" ShowHeader="false" LabelWidth="120px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow5">
                            <Items>
                                <f:TextBox runat="server" ID="UnitID" Label ="單位ID" Required="true" ShowRedStar="true" /> 
                            </Items>
                        </f:FormRow>
                        <f:FormRow ID="FormRow6">
                            <Items>
                                <f:TextBox runat="server" ID="UnitName" Label ="單位名稱" Required="true" ShowRedStar="true" /> 
                            </Items>
                        </f:FormRow>
                    </Rows>
                </f:Form>
