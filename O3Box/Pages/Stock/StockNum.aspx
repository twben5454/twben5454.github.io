<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockNum.aspx.cs" Inherits="Sales" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="倉庫管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            DataKeyNames="StockID ,StockName"  SortField="StockID" SortDirection="Desc"  >
            <Toolbars>
            ...
            <Columns>
                <f:BoundField Width="200px" DataField="StockID" DataFormatString="{0} " HeaderText="倉庫ID" SortField="StockID" /> 
                <f:BoundField Width="200px" DataField="StockName" DataFormatString="{0} " HeaderText="倉庫名稱" SortField="StockName" /> 
                ...
                <f:Form ID="SimpleForm1" CssClass="blockpanel" BodyPadding="5 5 0 5" LabelAlign="right" ShowHeader="false" LabelWidth="120px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow5" ColumnWidths="50% 50%">
                            <Items>
                                <f:TextBox runat = "server" ID = "StockID" Label = "倉庫ID" Required = "true" ShowRedStar="true" />
