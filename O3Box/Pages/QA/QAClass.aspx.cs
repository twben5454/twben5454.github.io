...
public partial class QAClass : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblQAClass   Where QAClassID <> '' ";
        if (this.txtSearch.Text.Length > 0)
        {
            strSQL += " and (QAClassID Like '%" + this.txtSearch.Text + "%' or QAClassName like '%" + this.txtSearch.Text + "%')";
        }
    ...
    protected void Grid1_RowCommand(object sender, FineUIPro.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Action1")
        {
            ...
            this.QAClassID.Text = keys[0].ToString();
            this.QAClassID.Readonly = true;
            this.QAClassName.Text = keys[1].ToString();
        ...
        if (e.CommandName == "Action2")
        {
            ...
            strSQL = @"Update   tblQAClass Set IsUse = '" + IsUse + "',Updated = '" + DB.getObject().GetCreated(this) + "'  Where QAClassID = '" + keys[0].ToString() + "'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            strSQL = "Insert Into tblQAClass (QAClassName ,Created) Values ('" + this.QAClassName.Text + "','" + DB.getObject().GetCreated(this) + "')";
            if (DB.getObject().Execute(strSQL, null, false).Success == true)
            {
        ...
        {
            strSQL = "Update tblQAClass  Set QAClassName = '" + this.QAClassName.Text + "',Updated = '" + DB.getObject().GetCreated(this) + "' Where QAClassID ='" + this.QAClassID.Text + "'";
            if (DB.getObject().Execute(strSQL, null, false).Success == true)
            {
