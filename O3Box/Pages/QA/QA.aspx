...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="问与答管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            DataKeyNames="QAID ,QAAsk ,QAAnswer,QAClassID,IsUse"  SortField="QAID" SortDirection="Desc"  >
            <Toolbars>
            ...
            <Columns>
                <f:BoundField Width="100px" DataField="QAID" DataFormatString="{0} " HeaderText="ID" SortField="QAID" /> 
                <f:BoundField Width="200px" DataField="QAAsk" DataFormatString="{0} " HeaderText="问" SortField="QAAsk" /> 
                <f:BoundField Width="200px" DataField="QAAnswer" DataFormatString="{0} " HeaderText="答" SortField="QAAnswer" /> 
                ...
                <f:Form ID="SimpleForm1" CssClass="blockpanel" BodyPadding="5 5 0 5" LabelAlign="right" ShowHeader="false" LabelWidth="120px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow5">
                            <Items>
                                <f:TextBox ID="QAID" runat="server" Label="ID" ShowRedStar="true" Required="true" LabelWidth="120px"></f:TextBox>
                            </Items>
                        </f:FormRow>
                        <f:FormRow ID="FormRow3">
                            <Items>
                                <f:DropDownList ID="QAClassID" runat="server" Label="分类" ShowRedStar="true"  LabelWidth="120px"></f:DropDownList>
                            </Items>
                        </f:FormRow>
                        <f:FormRow ID="FormRow6">
                            <Items>
                                <f:TextArea ID="QAAsk" runat="server" Label="问" ShowRedStar="true" Required="true" LabelWidth="120px"></f:TextArea>
                            </Items>
                        </f:FormRow>
                         <f:FormRow ID="FormRow16">
                            <Items>
                                <f:TextArea ID="QAAnswer" runat="server" Label="答" ShowRedStar="true" Required="true" LabelWidth="120px"></f:TextArea>
                            </Items>
                        </f:FormRow>
                    </Rows>
                </f:Form>
