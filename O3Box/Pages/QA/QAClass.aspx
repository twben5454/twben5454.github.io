<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QAClass.aspx.cs" Inherits="QAClass" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="问与答分类管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            DataKeyNames="QAClassID,QAClassName ,IsUse"  SortField="QAClassID" SortDirection="Desc"  >
            <Toolbars>
            ...
            <Columns>
               <f:BoundField Width="100px" DataField="QAClassID" DataFormatString="{0} " HeaderText="ID" SortField="QAClassID" /> 
             <f:BoundField Width="200px" DataField="QAClassName" DataFormatString="{0} " HeaderText="名称" SortField="QAClassName" />
                ...
                <f:Form ID="SimpleForm1" CssClass="blockpanel" BodyPadding="5 5 0 5" LabelAlign="right" ShowHeader="false" LabelWidth="120px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow5">
                            <Items>
                               <f:TextBox runat="server" ID="QAClassID" Label ="ID" Required="true"/> 
                            </Items>
                        </f:FormRow>
                        <f:FormRow ID="FormRow6">
                            <Items>
                               <f:TextBox runat="server" ID="QAClassName" Label ="分类名称" Required="true"/>
                            </Items>
                        </f:FormRow>
                    </Rows>
                </f:Form>
