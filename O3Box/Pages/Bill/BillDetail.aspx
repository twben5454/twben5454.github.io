<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BillDetail.aspx.cs" Inherits="BillDetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" CssClass="blockpanel" BodyPadding="5 5 0 5" LabelAlign="right" ShowHeader="true" LabelWidth="120px"
            Title="單據明細" runat="server">
            <Toolbars>
                 <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                     <Items>
                         <f:Button runat="server" ID="btnBack" CssClass="btn bg-success text-white " Text="回列表" CssStyle="background-color:gray;color:white;" OnClick="btnBack_Click" ></f:Button>
            ...
            <Rows>
                <f:FormRow ID="FormRow5" ColumnWidths="33% 33% 34%">
                    <Items>
                        ...
                        <f:RadioButtonList runat="server" ID="BillType" Label="類別" AutoPostBack="true" OnSelectedIndexChanged="BillType_SelectedIndexChanged">
                            <f:RadioItem Text ="進貨" Value ="SI" Selected="true" />
                            <f:RadioItem Text ="進貨退回" Value ="IR" />
                            <f:RadioItem Text ="調撥" Value ="ST" />
                            <f:RadioItem Text ="調整" Value ="AD" />
                            <f:RadioItem Text ="其他" Value ="OT" />
                        </f:RadioButtonList>
                    </Items>
                </f:FormRow>
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar2" Position="Top" runat="server">
                    <Items>
                        ...
                        <f:TextBox runat="server" ID="txtMemo" Label="備註"  LabelAlign="Right"></f:TextBox>
