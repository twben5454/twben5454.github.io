...
public partial class DMType : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblClass Where ClassType ='单位类型'";
    ...
    protected void Grid1_RowCommand(object sender, FineUIPro.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Action3")
        {
            ...
            string strSQL = string.Empty;
            strSQL = @"Update tblClass Set IsUse ='" + IsUse + "' Where ClassID ='" + keys[0].ToString() + "'";
            if (DB.getObject().Execute(strSQL, null, false).Success == true)
            {
                BindGrid();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            strSQL = @"INSERT INTO tblClass  (ClassType,ClassNo,ClassName)VALUES('单位类型','" + this.txtNo.Text + @"','" + this.txtName.Text + @"')";
            AlertMsg = "新增成功";
        }
        else
        {
