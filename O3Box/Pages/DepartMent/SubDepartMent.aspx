<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubDepartMent.aspx.cs" Inherits="SubDepartMent" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="组织部门管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            DataKeyNames="DepartID ,DepartName ,LinkDepartID,DMLevel,DMLocation,DMType ,LinkDepartID"  SortField="DepartID" SortDirection="Asc"  >
            <Toolbars>
                <f:Toolbar ID="Toolbar3" Position="Top" runat="server" >
                    <Items>
                        ...
                        <f:DropDownList runat="server" ID="DropDownList4" Label="单位" Width="200px" LabelWidth="50px" />
            ...
            <Columns>
                <f:RowNumberField />
                <f:BoundField Width="200px" DataField="LinkDepartName" DataFormatString="{0} " HeaderText="单位" SortField="ClassName" /> 
                <f:BoundField Width="50px" DataField="DepartID" DataFormatString="{0} " HeaderText="编号" SortField="ClassNo" /> 
                <f:BoundField Width="200px" DataField="DepartName" DataFormatString="{0} " HeaderText="部门名称" SortField="ClassName" /> 
        ...
        <f:Window ID="Window1" runat="server" Hidden="true" Width="400px" Height="300px" Title="维护" BodyPadding="5px"
            ...
            <Items>
                <f:SimpleForm runat="server" ID="SimpleForm1" ShowHeader="false" LabelAlign="Right">
                    <Items>
                        <f:DropDownList runat="server" ID="dpLink" Label="单位" Required="true" AutoPostBack="true" OnSelectedIndexChanged="dpLink_SelectedIndexChanged" />
