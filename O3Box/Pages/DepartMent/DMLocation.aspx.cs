...
public partial class DMLocation : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblClass Where ClassType ='位置'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            strSQL = @"INSERT INTO tblClass  (ClassType,ClassNo,ClassName)VALUES('位置','" + this.txtNo.Text + @"','" + this.txtName.Text + @"')";
            AlertMsg = "新增成功";
        }
        else
        {
