...
public partial class Table : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            this.Grid1.Title = Request.QueryString["id"].ToString() + " 欄位說明";
            BindGrid();
        }
    }
    ...
    void BindGrid()
    {
        ...
        string strSQL = @" SELECT a.name 字段名 ,
                            ...
                            WHERE d.name = '" + Request.QueryString["id"].ToString() + @"' ";
    ...
    protected void Grid1_AfterEdit(object sender, FineUIPro.GridAfterEditEventArgs e)
    {
        ...
        string strSQL = "exec sp_ModifyColumDesc '" + Request.QueryString["id"].ToString() + "','" + keys[0].ToString() + "',N'" + NewDesc + "'";
    ...
    {
        FineUIPro.PageContext.Redirect("DBList.aspx");
    }
}