<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDiscountOrder.aspx.cs" Inherits="AddDiscountOrder" %>
            ...
            <Rows>
                <f:FormRow ID="FormRow5" ColumnWidths="33% 33% 34%">
                    <Items>
                        ...
                        <f:DropDownList runat="server" ID="CountryID" Label="加入地區" Required="true"  ShowRedStar="true" >
                        </f:DropDownList>
                    </Items>
                </f:FormRow>
                <f:FormRow  ColumnWidths="33% 33% 34%">
                    <Items>
                        ...
                        <f:RadioButtonList  runat="server" ID="PayType" Label="付款方式" Required="false"  ShowRedStar="false"/>
