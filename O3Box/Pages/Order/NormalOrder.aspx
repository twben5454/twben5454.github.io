<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NormalOrder.aspx.cs" Inherits="NormalOrder" %>
        ...
        <f:Form ID="SimpleForm1" CssClass="blockpanel" BodyPadding="5 5 0 5" LabelAlign="right" ShowHeader="true" LabelWidth="120px"
            ...
            <Rows>                
                <f:FormRow  ColumnWidths="33% 33% 34%">
                    <Items>
                        <f:TriggerBox ID="UpMemberID" ShowLabel="true" Readonly="false" TriggerIcon="Search" Label="會員ID"  ShowRedStar="true"
                            OnTriggerClick="MemberID_TriggerClick" EmptyText="點選選擇會員ID" runat="server" EnablePostBack="true"  >
                        </f:TriggerBox>
                        <f:TextBox runat="server" ID="UpMemberName" Label="會員名稱" Required="true"  ShowRedStar="true"/>
                        <f:TextBox runat="server" ID="UpMemberClassID" Label="會員等級" Required="true"  ShowRedStar="true"/>
                    </Items>
                </f:FormRow>
                <f:FormRow  ColumnWidths="33% 33% 34%">
                    <Items>
