...
public partial class Order : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select 
	                        a.* ,b.MemberName ,c.RestaurantName 
                        From tblOrderM a
                        left join tblMember b on a.MemberID = b.MemberID 
                        left join tblRestaurant c on c.RestaurantID = a.RestaurantID
                            Where a.IsUse ='True' ";
        if (this.txtSearch.Text.Length > 0)
        {
            strSQL += " and (a.OrderID Like '%" + this.txtSearch.Text + "%' or b.MemberName like '%" + this.txtSearch.Text + "%')";
        }
    ...
    protected void Grid1_RowCommand(object sender, FineUIPro.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Action2")
        {
            ...
            strSQL = @"Update   tblOrder Set IsUse = 'False'  Where OrderID = '" + keys[0].ToString() + "'";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        this.OrderID.Text = "自动编号";
        this.OrderID.Readonly = true;
        this.Window1.Hidden = false;
        DB.FillFineUIDropDownList(this.MemberID, "Select MemberName,MemberID From tblMember Where IsUse='True'", "");
        DB.FillFineUIDropDownList(this.RestaurantID, "Select RestaurantName,RestaurantID From tblRestaurant Where IsUse='True'", "");
    }
