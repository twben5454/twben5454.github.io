...
public partial class GroupOrder : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"select 
	                            a.MemberID ,b.*
                            From tblMember a
                            Left join tblOrderM b on a.MemberID =b.MemberID 
                            Where a.UpGroup like '%' +'" + Request.QueryString["id"].ToString() + "' + '%' ";
        if (this.txtSearch.Text.Length > 0)
        {
            strSQL += " and (a.MemberID Like '%" + this.txtSearch.Text + "%' or b.OrderID like '%" + this.txtSearch.Text + "%')";
        }
