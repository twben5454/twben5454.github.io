...
public partial class MemberOrder : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblOrderM Where MemberID='" + Request.QueryString["id"].ToString() + "' ";
        if (this.txtSearch.Text.Length > 0)
        {
            strSQL += " and (MemberID Like '%" + this.txtSearch.Text + "%' or OrderID like '%" + this.txtSearch.Text + "%')";
        }
