...
public partial class MemberPromotion : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select a.* ,b.MemberClassName as SourceClassName , c.MemberClassName as TargetClassName 
                            From tblMemberPromotion a
                            Left join tblMemberClass b on a.SourceMemberClassID = b.MemberClassID
                            Left join tblMemberClass c on a.TargetMemberClassID = c.MemberClassID
                            Where a.MemberID ='" +  Request.QueryString["id"].ToString()+ "' ";
