...
public partial class GroupBonus : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"select 
	                            a.MemberID,a.lvl , a.MemberName ,b.*
                            From tblMember a
                            Left join tblBonus b on a.MemberID =b.MemberID 
                            Where a.UpGroup like '%" + Request.QueryString["id"].ToString() + "%' and b.YM ='" + this.YM.SelectedValue + "' ";
