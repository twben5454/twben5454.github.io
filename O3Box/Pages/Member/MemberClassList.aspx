<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberClassList.aspx.cs" Inherits="MemberClassList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="会员类别管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            DataKeyNames="MemberClassID ,MemberClassName"  SortField="MemberClassID" SortDirection="Desc"  >
            <Toolbars>
            ...
            <Columns>
                ...
                <f:BoundField Width="200px" DataField="MemberClassName" DataFormatString="{0} " HeaderText="名称" SortField="MemberClassName" /> 
                ...
                <f:Form ID="SimpleForm1" CssClass="blockpanel" BodyPadding="5 5 0 5" LabelAlign="right" ShowHeader="false" LabelWidth="120px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow5">
                            <Items>
                                <f:TextBox ID="MemberClassID" runat="server" Label="会员分类ID" ShowRedStar="true" Required="true" LabelWidth="120px"></f:TextBox>
                            </Items>
                        </f:FormRow>
                        <f:FormRow ID="FormRow6">
                            <Items>
                                <f:TextBox ID="MemberClassName" runat="server" Label="会员分类名称" ShowRedStar="true" Required="true" LabelWidth="120px"></f:TextBox>
                            </Items>
                        </f:FormRow>
                    </Rows>
                </f:Form>
