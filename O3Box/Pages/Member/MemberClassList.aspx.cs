...
public partial class MemberClassList : System.Web.UI.Page
{
    ...
    protected void Grid1_RowCommand(object sender, FineUIPro.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Action2")
        {
            ...
            strSQL = @"Update   tblMemberClass Set IsUse = 'False'  Where MemberClassID = '" + keys[0].ToString() + "'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            strSQL = "Insert Into tblMemberClass (MemberClassName) Values ('" + this.MemberClassName.Text + "')";
            if (DB.getObject().Execute(strSQL, null, false).Success == true)
            {
