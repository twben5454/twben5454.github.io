...
public partial class ArticleClass : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblArticleClass   Where ArticleClassID <> '' ";
        if (this.txtSearch.Text.Length > 0)
        {
            strSQL += " and (ArticleClassID Like '%" + this.txtSearch.Text + "%' or ArticleClassName like '%" + this.txtSearch.Text + "%')";
        }
    ...
    protected void Grid1_RowCommand(object sender, FineUIPro.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Action1")
        {
            ...
            this.ArticleClassID.Text = keys[0].ToString();
            this.ArticleClassID.Readonly = true;
            this.ArticleClassName.Text = keys[1].ToString();
        ...
        if (e.CommandName == "Action2")
        {
            ...
            strSQL = @"Update   tblArticleClass Set IsUse = '" + IsUse + "',Updated = '" + DB.getObject().GetCreated(this) + "'  Where ArticleClassID = '" + keys[0].ToString() + "'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            strSQL = "Insert Into tblArticleClass (ArticleClassName ,Created) Values ('" + this.ArticleClassName.Text + "','" + DB.getObject().GetCreated(this) + "')";
            if (DB.getObject().Execute(strSQL, null, false).Success == true)
            {
        ...
        {
            strSQL = "Update tblArticleClass  Set ArticleClassName = '" + this.ArticleClassName.Text + "',Updated = '" + DB.getObject().GetCreated(this) + "' Where ArticleClassID ='" + this.ArticleClassID.Text + "'";
            if (DB.getObject().Execute(strSQL, null, false).Success == true)
            {
