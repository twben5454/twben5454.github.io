<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleClass.aspx.cs" Inherits="ArticleClass" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="文章分类管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            DataKeyNames="ArticleClassID,ArticleClassName ,IsUse"  SortField="ArticleClassID" SortDirection="Desc"  >
            <Toolbars>
            ...
            <Columns>
               <f:BoundField Width="100px" DataField="ArticleClassID" DataFormatString="{0} " HeaderText="ID" SortField="ArticleClassID" /> 
             <f:BoundField Width="200px" DataField="ArticleClassName" DataFormatString="{0} " HeaderText="名称" SortField="ArticleClassName" />
                ...
                <f:Form ID="SimpleForm1" CssClass="blockpanel" BodyPadding="5 5 0 5" LabelAlign="right" ShowHeader="false" LabelWidth="120px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow5">
                            <Items>
                               <f:TextBox runat="server" ID="ArticleClassID" Label ="ID" Required="true"/> 
                            </Items>
                        </f:FormRow>
                        <f:FormRow ID="FormRow6">
                            <Items>
                               <f:TextBox runat="server" ID="ArticleClassName" Label ="分类名称" Required="true"/>
                            </Items>
                        </f:FormRow>
                    </Rows>
                </f:Form>
