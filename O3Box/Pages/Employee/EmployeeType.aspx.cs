...
public partial class EmployeeType : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblClass Where ClassType ='检查人员类型'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            strSQL = @"INSERT INTO tblClass  (ClassType,ClassNo,ClassName)VALUES('检查人员类型','" + this.txtNo.Text + @"','" + this.txtName.Text + @"')";
            AlertMsg = "新增成功";
        }
        else
        {
