<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeType.aspx.cs" Inherits="EmployeeType" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="检查人员类型" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true"
            ...
            DataKeyNames="ClassID ,ClassNo ,ClassName"  SortField="ClassNo" SortDirection="Asc"  >
            <Toolbars>
