...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="检查人员管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            DataKeyNames="EmployeeID,EmployeeName,IDNo,EnforceNo,CellPhone,DepartMentID,DepartMentID2 ,IsUse ,EmployeeType"  SortField="EmployeeID" SortDirection="Asc"  >
            <Toolbars>
                <f:Toolbar ID="Toolbar3" Position="Top" runat="server" >
                    <Items>
                        ...
                        <f:DropDownList runat="server" ID="DropDownList1" Label="单位" Width="200px" LabelWidth="50px" />
                        <f:DropDownList runat="server" ID="DropDownList2" Label="部门"  Width="200px" LabelWidth="50px" />
                        <f:DropDownList runat="server" ID="DropDownList3" Label="人员类型"  Width="200px" LabelWidth="80px" />
            ...
            <Columns>
                <f:BoundField Width="100px" DataField="EmployeeID" DataFormatString="{0} " HeaderText="编号" SortField="EmployeeID" /> 
                <f:BoundField Width="100px" DataField="EmployeeName" DataFormatString="{0} " HeaderText="姓名" SortField="EmployeeName" /> 
                <f:BoundField Width="100px" DataField="ClassName" DataFormatString="{0} " HeaderText="人员类型" SortField="ClassName" /> 
                <f:BoundField Width="100px" DataField="IDNo" DataFormatString="{0} " HeaderText="身份证字号" SortField="IDNo" /> 
                <f:BoundField Width="100px" DataField="EnforceNo" DataFormatString="{0} " HeaderText="执法证号" SortField="EnforceNo" /> 
                <f:BoundField Width="100px" DataField="DepartName" DataFormatString="{0} " HeaderText="单位名称" SortField="DepartName" /> 
                <f:BoundField Width="100px" DataField="SubDepartName" DataFormatString="{0} " HeaderText="部门名称" SortField="SubDepartName" /> 
                <f:BoundField Width="100px" DataField="CellPhone" DataFormatString="{0} " HeaderText="联系电话" SortField="CellPhone" /> 
