<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppBanner.aspx.cs" Inherits="AppBanner" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="App Banner管理" EnableFrame="true" EnableCollapse="false" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            <Items>
                <f:SimpleForm runat="server" ID="SimpleForm1" ShowHeader="false" LabelAlign="Right">
                    <Items>
                        ...
                        <f:TextBox runat="server" ID ="Text1" Label="建议尺寸" Text="450 x 150" Readonly ="true" />
