...
public partial class AppBanner : PageBase
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblBanner Where BannerType = '2' ";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (this.Window1.Title == "新增")
        {
            strSQL = @"Insert Into tblBanner(  
                        ...
                        Values  
                        ('2','" +BannerText.Text + "','" + BannerUrl.Text + "','" + imgPhoto.ImageUrl.Replace("~/upload/","") + "','" + DB.getObject().GetNowString() + "') ";
