...
public partial class WebBanner : PageBase
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblBanner Where BannerType = '1' ";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (this.Window1.Title == "新增")
        {
            strSQL = @"Insert Into tblBanner(  
                        ...
                        Values  
                        ('1','" +BannerText.Text + "','" + BannerUrl.Text + "','" + imgPhoto.ImageUrl.Replace("~/upload/","") + "','" + DB.getObject().GetNowString() + "') ";
