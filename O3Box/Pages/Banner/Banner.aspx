<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Banner.aspx.cs" Inherits="Page_Banner_Banner" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="Banner管理" EnableFrame="true" EnableCollapse="false" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            <Columns>
                ...
                <f:BoundField Width="100px" DataField="BannerType" DataFormatString="{0} " HeaderText="类别" SortField="BannerType" /> 
                ...
                <f:BoundField Width="100px" DataField="IsUse" DataFormatString="{0} " HeaderText="" SortField="IsUse" /> 
            ...
            <Items>
                <f:SimpleForm runat="server" ID="SimpleForm1" ShowHeader="false" LabelAlign="Right">
                    <Items>
                        ...
                        <f:RadioButtonList runat="server" ID="BannerType" Label="类别" Required="false" >
                            <f:RadioItem Text="网站" Selected="true" Value="0" />
                            <f:RadioItem Text="公众号"  Value="1"  />
                            </f:RadioButtonList>
