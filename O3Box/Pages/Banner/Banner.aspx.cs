...
public partial class Page_Banner_Banner : PageBase
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblBanner Where IsUse ='True'";
        if (this.txtSearch.Text.Length > 0)
        {
            strSQL += " and (BannerID Like '%" + this.txtSearch.Text + "%' or BannerText like '%" + this.txtSearch.Text + "%')";
        }
    ...
    protected void Grid1_RowCommand(object sender, FineUIPro.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Action1")
        {
            ...
            ClearFormData();
            this.BannerID.Text = keys[0].ToString();
            this.BannerType.SelectedValue= keys[1].ToString();
            this.BannerText.Text = keys[2].ToString();
            this.BannerUrl.Text = keys[3].ToString();
            this.imgPhoto.ImageUrl= "~/upload/" +keys[4].ToString();
    ...
    {
        this.BannerID.Text = "自动编号";
        this.BannerID.Readonly = true;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            strSQL = @"Insert Into tblBanner(  
                        BannerType,BannerText,BannerUrl,BannerImage,Created) 
                        Values  
                        ('" + BannerType.SelectedValue + "','" +BannerText.Text + "','" + BannerUrl.Text + "','" + imgPhoto.ImageUrl.Replace("~/upload/","") + "','" + DB.getObject().GetNowString() + "') ";
