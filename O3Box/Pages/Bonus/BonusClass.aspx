<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BonusClass.aspx.cs" Inherits="BonusClass" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="獎金類別管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            DataKeyNames="BonusClassID,BonusClassName"  SortField="BonusClassID" SortDirection="Asc"  >
            <Toolbars>
            ...
            <Columns>
               <f:BoundField Width="100px" DataField="BonusClassID" DataFormatString="{0} " HeaderText="ID" SortField="BonusClassID" /> 
                <f:BoundField Width="400px" DataField="BonusClassName" DataFormatString="{0} " HeaderText="名稱" SortField="BonusClassName" />
                <f:BoundField Width="250px" DataField="BonusPercent" DataFormatString="{0} " HeaderText="獎金比例 %" SortField="BonusPercent" TextAlign="Right" />
