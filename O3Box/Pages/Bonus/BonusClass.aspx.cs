...
public partial class BonusClass : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select * From tblBonusClass   Where BonusClassID <> '' ";
        if (this.txtSearch.Text.Length > 0)
        {
            strSQL += " and (BonusClassID Like '%" + this.txtSearch.Text + "%' or BonusClassName like '%" + this.txtSearch.Text + "%')";
        }
