...
public partial class Admin_Page_Member_MemberBonus : System.Web.UI.Page
{
    ...
    void BindGrid()
    {
        ...
        string strSQL = @"Select 
	                            a.* ,b.MemberName ,c.BonusClassName
                            From tblMemberBonus a 
                            Left join tblMember b on a.MemberID = b.MemberID
                            Left join tblBonusClass c on a.BonusClassID = c.BonusClassID
                            Where a.MemberID <> '' ";
