<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberBonus.aspx.cs" Inherits="Admin_Page_Member_MemberBonus" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="獎金管理" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" CssClass="blockpanel"
            ...
            <Columns>
                ...
                <f:BoundField Width="150px" DataField="BonusClassName" DataFormatString="{0} " HeaderText="獎金類別" SortField="BonusClassName" /> 
                <f:BoundField Width="150px" DataField="Amount" DataFormatString="{0:N0} " HeaderText="金額" SortField="Amount" TextAlign="Right" /> 
               <%-- <f:LinkButtonField TextAlign="Center"  Text="" ColumnID="lbfAction1" HeaderText="訂單分配" Icon="UserHome" ToolTip="訂單分配"  Width="100px" CommandName="Action1" />--%>
            </Columns>
        </f:Grid>
    </form>
</body>
