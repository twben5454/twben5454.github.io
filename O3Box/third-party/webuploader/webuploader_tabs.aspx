                        ...
                        <f:Grid ID="Grid1" runat="server" ShowHeader="false" ShowBorder="true"
                            ...
                            <Toolbars>
                                <f:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        <f:Button runat="server" ID="btnSelectFiles" EnablePostBack="false" IconFont="_Plus" Text="选择文件上传"></f:Button>
                                    </Items>
                                </f:Toolbar>
                            </Toolbars>
                            <Columns>
                        ...
                        <f:Grid ID="Grid2" runat="server" ShowHeader="false" ShowBorder="true"
                            ...
                            <Toolbars>
                                <f:Toolbar runat="server">
                                    <Items>
                                        <f:Button runat="server" ID="btnSelectFiles2" EnablePostBack="false" IconFont="_Plus" Text="选择图片上传"></f:Button>
                                    </Items>
                                </f:Toolbar>
                            </Toolbars>
                            <Columns>
