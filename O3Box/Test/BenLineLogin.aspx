<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BenLineLogin.aspx.cs" Inherits="Test_BenLineLogin" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script>
        ...
        function Auth() {
            ...
            URL += '&client_id=1656282927';   //TODO:這邊要換成你的client_id
            URL += '&redirect_uri=http://localhost:50270/Test/callback.aspx';   //TODO:要將此redirect url 填回你的 LineLogin後台設定
        ...
        function AuthWithEmail() {
            var URL = 'https://access.line.me/oauth2/v2.1/authorize?';
            URL += 'response_type=code';
            URL += '&client_id=U3de23f507aa838118c5238831f2612c4';   //TODO:這邊要換成你的client_id
            URL += '&redirect_uri=http://localhost:50270/Test/callback.aspx';   //TODO:要將此redirect url 填回你的 LineLogin後台設定
